...
why the db_user.id is converted to string:
db_user.id should be string since JWT claims must be serializable and many libraries expect "sub" to be a string, not an integer.